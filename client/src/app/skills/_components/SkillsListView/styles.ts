...
/** Co-located styles for SkillsListView. Deliberately the same numbers as
    AgentsListView: the two screens sit next to each other in the sidebar, and
    a different page padding or heading size reads as a different product. */
export const s = {
