 ...
 *
 * Scope: in-process. Used by modules/repo-intel for the budget search above,
 * and by modules/reviews to report how many tokens the skills block added to a
 * prompt (reviewer-core is pure and has no tokenizer of its own). Swappable in
